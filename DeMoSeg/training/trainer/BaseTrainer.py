...
class BasicTrainer(object):
    ...
    def get_datafile_augmentation(self):
        ...
        self.train_transform = transforms.Compose(
            [
                ...
                transforms.RandScaleIntensityd(keys="image", factors=(0.7, 1.4), prob=1.0),
    ...
    def get_network(self):
        ...
        self.network = Baseline(input_channels=4, num_classes=num_classes[self.task], num_pool=5, upsample=self.upsample)
    ...
    def get_loss(self):
        loss = DiceCELoss(include_background=False, to_onehot_y=True, softmax=not self.upsample)
